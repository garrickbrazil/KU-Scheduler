/*
 	This file is part of KU-Scheduler.

	KU-Scheduler is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    KU-Scheduler is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU General Public License for more details.

    You should have received a copy of the GNU General Public License
    along with KU-Scheduler.  If not, see <http://www.gnu.org/licenses/>.
*/
...
public class MainApplication extends JPanel implements ActionListener{
	...
	public MainApplication(){
	    ...
	    // KU Scheduler License
	    schedulerItem= new JMenuItem("KU Scheduler");
	...
	public static void storeScheduleFile(String filename, Scheduler save){
		...
		try{
			...
			if(!filename.matches(".*\\.kusch")) filename += ".kusch";
	...
	@Override public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource() == saveB || event.getSource() == saveItem){
			...
			FileNameExtensionFilter filter = new FileNameExtensionFilter(
	                "KU schedule files (*.kusch)", "kusch");
	        fc.setFileFilter(filter);
			fc.setApproveButtonText("Save");
			fc.setDialogTitle("Save File");
			
			// Ask user for file with correct extention kusch
		...
		// If settings have a state change
			...
			JOptionPane.showOptionDialog(this,
					"This application is part of KU Scheduler." +
					"\n" +
				    "\nKU Scheduler is free software: you can redistribute it and/or modify" +
					...
					,"KU Scheduler License", JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE, null, new Object[]{}, null);
		}
			...
			// Show this applications license
			JOptionPane.showOptionDialog(this,
					   "The purpose of the application is to help KU University\n" +
					   "students determine the best schedule for them utilizing various\n" +
					   "filter techniques and a visual display.",
						"KU Scheduler Purpose", JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE, null, new Object[]{}, null);
			...
			JOptionPane.showOptionDialog(this,
					   ...
					   "www.github.com/garrickbrazil/KU-Scheduler",
			...
			// Show this applications license
			JOptionPane.showOptionDialog(this,
					   "Load a course set from a previously saved data file (.kusch)\n" + 
