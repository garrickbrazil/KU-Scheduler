 ...
 * Purpose: used to log into KU server and download course data
/*******************************************************************/
@SuppressWarnings("deprecation") class DownloadDialog extends JDialog implements ActionListener {
	...
	final String[] SUBJECTS = {"ACCT","BINF","BIOL","BUSN","CHME","CHEM","CHN","COMM",
			"CE","CS","CUE","ECON","ECE","EE","FINC","FYE","GER","HIST","HUMN","IME",
			"ISYS","INEN","MFGO","LS","LIT","MGMT","MRKT","MATH","MECH","MEDI","PHIL",
			"PHYS","SSCI","SOC"};

	// Title of Dialog
	private final static String TITLE = "KU Downloader";
			...
			protected Void doInBackground() throws Exception{
				...
				try{
		            ...
		            if(loggedIn){
						...
						HttpGet classList = new HttpGet("http://jweb.kettering.edu/cku1/bwskfcls.p_sel_crse_search");
						...
						HttpGet coursePage = new HttpGet("http://jweb.kettering.edu/cku1/bwckgens.p_proc_term_date?p_calling_proc=P_CrseSearch&p_term=" + term);
						coursePage.setHeader("Referer", "http://jweb.kettering.edu/cku1/bwskfcls.p_sel_crse_search"); 
